...
async function handleConnectConfigured(ws, serverId) {
...
async function handleConnectStdio(ws, command, args, configName) {
...
function markConnectionAsConnected(connection, serverInfo, displayName) {
    connection.status = 'connected';
